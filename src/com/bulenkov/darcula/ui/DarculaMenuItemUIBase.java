...
public class DarculaMenuItemUIBase extends BasicMenuItemUI {
  ...
  protected void paintMenuItem(Graphics g, JComponent c,
    ...
    applyInsets(viewRect, mi.getInsets());
      ...
      // fix bug on Mac OS Java 6: 'acceleratorDelimiter' has private access in 'javax.swing.plaf.basic.BasicMenuItemUI
      // 2016-10-13 BeanSoft@126.com
      String _acceleratorDelimiter = null;
      try {
          Field acceleratorDelimiterField = getClass().getField("acceleratorDelimiter");
          acceleratorDelimiterField.setAccessible(true);
          _acceleratorDelimiter = (String)acceleratorDelimiterField.get(this);
      } catch (Exception e) {
          e.printStackTrace();
      }
    ...
    MenuItemLayoutHelper lh = new MenuItemLayoutHelper(mi, checkIcon,
        arrowIcon, viewRect, defaultTextIconGap, _acceleratorDelimiter , // acceleratorDelimiter, old code
